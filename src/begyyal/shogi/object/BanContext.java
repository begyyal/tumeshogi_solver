...
public class BanContext {
    ...
    // 持ち駒は最新断面のみ
    private final SuperList<Koma> selfMotigoma;
    private final SuperList<Koma> opponentMotigoma;
    ...
    private BanContext(SuperList<Ban> log, SuperList<Koma> selfMotigoma, SuperList<Koma> opponentMotigoma) {
	this.log = log;
	...
	SuperList<Koma> motigoma = SuperListGen.newi();
