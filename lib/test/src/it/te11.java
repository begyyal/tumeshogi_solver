...
public class te11 {
	private static final Logger logger = Logger.getLogger("te11");
	@Test
	public void p1() {
		...
		try(var solver = new TsSolver()) {
			...
			te11.logger.log(Level.SEVERE, "failed to p1.", e);
			fail("Error occured.");
		}
		...
		te11.logger.log(Level.INFO, () -> "te11_1 - " + (System.currentTimeMillis() - start) + "msec");
	}
	@Test
	public void p2() {
		long start = System.currentTimeMillis();
		...
		te11.logger.log(Level.INFO, () -> "te11_2 - " + (System.currentTimeMillis() - start) + "msec");
	}
}
